...
data1 = np.genfromtxt('correlacion_N32_T6.txt', delimiter = '\t')
...
inx_min = np.argmin(abs(ro))
print(inx_min/size_red)

print(ro[len(ro)-3])
print(iteracion[len(ro)-3]/size_red)
...
plt.plot(iteracion[::10]/size_red,ro[::10],'bo',markersize=2,zorder=3,label='N=32 T=3 ') 
...
pylab.savefig('correlacion_N32_T6.eps', format='eps', dpi=300, bbox_inches='tight')
