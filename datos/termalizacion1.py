...
data1 = np.genfromtxt('energia_magnetizacion.txt', delimiter = '\t')
...
plt.plot(energia[::100],'b-',markersize=3,zorder=3,label='energia') 
#plt.plot(magnetizacion[::100],'ro',markersize=3,zorder=3,label='magnetizacion') 

pylab.xlabel('iteracion')
...
pylab.savefig('termalizacion1.eps', format='eps', dpi=300, bbox_inches='tight')
