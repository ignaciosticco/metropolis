...
plt.plot(temperatura,susceptibilidad,'bo',markersize=3,zorder=3,label='N=32 ') 

pylab.xlabel('Temperatura')
pylab.ylabel('susceptibilidad')
pylab.legend()
#pylab.ylim(0.0, 1.1)
...
pylab.savefig('susceptibilidad(T)_N32.eps', format='eps', dpi=300, bbox_inches='tight')
